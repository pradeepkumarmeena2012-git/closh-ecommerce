...
// Get the actual base URL, but force WS port to 5000 if local development
const SOCKET_URL = IMAGE_BASE_URL.includes('localhost') ? 'http://localhost:5000' : IMAGE_BASE_URL;
