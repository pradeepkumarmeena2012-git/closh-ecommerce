                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100 flex-shrink-0">
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full pl-4 pr-12 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm resize-none"
                        rows="3"
                      />
                      <button
                        onClick={handleReply}
