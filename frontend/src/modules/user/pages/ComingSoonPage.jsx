    ...
    return (
        <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center relative overflow-hidden font-sans selection:bg-white/20">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-indigo-500/20 rounded-full blur-[150px] opacity-50" />
                <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-fuchsia-500/10 rounded-full blur-[150px] opacity-30" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-5xl px-6 py-12 md:py-20 flex flex-col items-center text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
                        ...
                        <span className="text-[11px] font-bold text-white/80 uppercase tracking-widest">Under Construction</span>
                    </div>
                    
                    <h2 className="text-5xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50 tracking-tight leading-[1.05] mb-8">
                        Elevating<br/>Luxury Fashion
                    </h2>
                    
                    <p className="text-lg md:text-xl text-white/50 font-medium leading-relaxed max-w-2xl mx-auto mb-12">
                ...
                >
                    ...
                    <div className="relative flex items-center bg-white/5 border border-white/10 rounded-2xl p-2 backdrop-blur-xl">
                        ...
                        <input 
                            ...
                            className="w-full bg-transparent border-none text-white placeholder-white/30 focus:outline-none focus:ring-0 text-sm py-3"
                        />
                        <button className="bg-white text-black px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-white/90 transition-transform active:scale-95 shrink-0">
                            Notify Me
                        </button>
                    </div>
                </motion.div>
