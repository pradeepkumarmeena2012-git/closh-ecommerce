    ...
    return (
        <AccountLayout>
            <div className="max-w-[800px] mx-auto pb-4">
                ...
                <div className="flex flex-col items-center mb-6 pt-2 px-2 md:px-4">
                    <input
                        type="file"
                        ref={fileInputRef}
                    ...
                    <div className="relative group cursor-pointer mb-4" onClick={triggerFileInput}>
                        <div className="w-28 h-28 md:w-36 md:h-36 rounded-full p-[4px] bg-gradient-to-tr from-[#FF5722]/20 to-[#FF5722]/5 shadow-sm group-hover:shadow-lg transition-all duration-500">
                    ...
                    <h2 className="text-xl md:text-3xl font-bold text-gray-900 leading-tight text-center px-4">
                        {formData.firstName} {formData.lastName}
                    </h2>
                    <div className="flex items-center gap-2 mt-2 px-4 py-1.5 bg-gray-50 rounded-full border border-gray-100">
                        <Check size={12} className="text-[#FF5722]" strokeWidth={3} />
                        <span className="text-[10px] md:text-[12px] font-bold text-gray-400 uppercase tracking-wider">Premium Member</span>
                    </div>
                </div>

                {/* Form Fields Section */}
                <div className="space-y-4 px-2 md:px-4 text-gray-900">
                    {/* Basic Info */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative group">
                            <label className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-gray-400 z-10">First Name</label>
                            <input
                                type="text"
                        ...
                        <div className="relative group">
                            <label className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-gray-400 z-10">Last Name</label>
                            <input
                                type="text"
                    ...
                    <div className="relative group">
                        <label className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-gray-400 z-10">Email Address</label>
                        <input
                            type="email"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative group">
                            <label className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-gray-400 z-10">Mobile Number</label>
                            <div className="flex items-center gap-2 w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus-within:ring-1 focus-within:ring-[#FF5722] focus-within:border-[#FF5722] transition-all">
                        ...
                        <div className="relative group">
                            <label className="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-gray-400 z-10">Date of Birth</label>
                            <input
                                type="date"
                    ...
                    {/* Gender Selection */}
                    <div className="pt-2">
                        <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 ml-1">Gender Identification</h4>
                        <div className="flex flex-wrap gap-2">
                            {genderOptions.map(opt => (
                                <button
                                    ...
                                    className={`px-6 py-2.5 rounded-xl text-[11px] font-bold uppercase transition-all duration-300 border ${formData.gender === opt
                        ...
                        <div className="relative">
                            {saveMessage && (
                                <div className="absolute -top-6 left-0 w-full flex justify-center">
                                    <span className="bg-emerald-500 text-white px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider animate-fade-in-up">
                                        {saveMessage}
                                    </span>
                                </div>
                            )}
                            <button
                                onClick={handleSave}
                                disabled={isSaving}
                                className="group relative w-full py-4 bg-black text-white rounded-xl overflow-hidden disabled:opacity-70 transition-all active:scale-[0.98] shadow-xl shadow-black/10"
                            >
                                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:animate-shimmer" />
                                <span className="relative font-bold text-[13px] md:text-[14px] uppercase tracking-wider">
